public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        double previousVal = 0;     // previous value in the series calculation.
        double currentVal = 1;      // current value in the series calculation.
        double error = Math.abs(currentVal - previousVal);      // calculate the error (as an abs val).
        ...
        while (error > THRESHOLD) {
            ...
            // keep track of how many steps it took to solve this problem.
            steps = steps + 1;
        }
        ...
        System.out.println(String.format("  steps = %04d, prev = %.08f, curr = %.08f, err = %.08f", steps, previousVal, currentVal, error));
